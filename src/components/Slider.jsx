  ...
  return (
    <div className='sm:w-3/5 lg:w-3/5 mx-auto my-1'>
      <Carousel showThumbs={false} autoPlay showArrows={true} infiniteLoop>
        <div>
          <img src={lenscart_slide1} className="h-[200px]" alt="img_2" />
        </div>

        <div>
          <img src={lenscart_slide2} className="h-[200px]" alt="img_2" />
        </div>

        <div>
          <img src={lenscart_slide3} className="h-[200px]" alt="img_1" />
        </div>
